"""
AMD Scenario 20: non-monotonic HIP_VISIBLE_DEVICES — gpuq sorts visible indices.

Run with: HIP_VISIBLE_DEVICES=5,1,3 python e2e/amd_20_nonmonotonic_ordering.py
"""
