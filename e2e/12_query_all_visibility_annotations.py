"""
Scenario 12: query visible_only=False — all GPUs with visibility annotations.

Run with: CUDA_VISIBLE_DEVICES=1,4 python e2e/12_query_all_visibility_annotations.py
"""
