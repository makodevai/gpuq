"""
AMD Scenario 14: Properties fields — uuid, name, hardware props, asdict.

Run with: python e2e/amd_14_properties_fields.py
"""
...
print(f"memory={g.total_memory}, sms={g.sms_count}, warp={g.warp_size}")
